...
- Low-budget Recipe Recommender | Web Development 📝 <br>
   - Current features: Using Spoonacular API (https://rapidapi.com/blog/build-food-website/), you can input your budget, nutrients, and diet and the app would recommend cheap recipes based on your input.
   - Additional Potential Features: <br>
         - Input the end date of your ingredients. The app will ping you when a food item is nearing its expiration date.<br>
